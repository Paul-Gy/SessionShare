...
<template>
  <div class="container my-5">
    <h1 class="text-center">
      <RouterLink to="/" target="_blank" rel="noopener noreferrer" class="link-body-emphasis">
        SessionShare
      </RouterLink>
    </h1>
    <p class="text-center mb-4">Easily share files in multiple times with a single link!</p>

    <div v-if="lastError" class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <p class="text-center">
      Open source on
      <a href="https://github.com/Paul-Gy/SessionShare" target="_blank" rel="noopener noreferrer"
        >GitHub</a
      >
